      ...
      <div style={{maxWidth:1100,margin:'0 auto',position:'relative'}}>
        <Fade>
          <div style={{textAlign:'center',marginBottom:64}}>
            ...
            <h2 className="kymia-h2" style={{fontSize:44,fontWeight:900,color:'white',margin:0,marginBottom:12}}>Verifiable on Solana blockchain.</h2>
            <p style={{fontSize:15,color:K.dim,lineHeight:1.8,margin:0}}>Every live trade is recorded on-chain. No claims. No promises.<br/>Just transparent, verifiable results anyone can check.</p>
          </div>
        </Fade>
        <Fade delay={.1}>
      ...
      <div style={{maxWidth:1000,margin:'0 auto'}}>
        <Fade>
          <div style={{textAlign:'center',marginBottom:64}}>
            ...
            <h2 className="kymia-h2" style={{fontSize:41,fontWeight:900,color:'white',margin:'0 0 12px'}}>Not simulated. Not estimated.</h2>
            <p style={{fontSize:15,color:K.dim,lineHeight:1.8,margin:0}}>Every signal comes from real institutional APIs.<br/>Hover any source to see which agents use it.</p>
          </div>
        </Fade>
        <Fade delay={.1}>
          <div>
      ...
      <div className="kymia-grid-2 kymia-hero-grid" style={{maxWidth:1100,margin:'0 auto',display:'grid',gridTemplateColumns:'320px 1fr',gap:40,alignItems:'start',position:'relative'}}>
        ...
        <div className="kymia-debate-full">
          <div style={{marginBottom:20}}>
            ...
            <h2 className="kymia-h2" style={{fontSize:46,fontWeight:900,color:'white',margin:0,lineHeight:1.2}}>Agents debate.<br/><span style={{color:K.c}}>Markets obey.</span></h2>
      ...
      <div style={{maxWidth:1100,margin:'0 auto'}}>
        <Fade>
          <div style={{textAlign:'center',marginBottom:48}}>
            ...
            <h2 className="kymia-h2" style={{fontSize:44,fontWeight:900,color:'white',margin:'0 0 12px'}}>No claims. Just results.</h2>
            <p style={{fontSize:15,color:K.dim,lineHeight:1.8,margin:0}}>Real sessions. Real trades. Real P&L.<br/>Including the losses — because that's what trust looks like.</p>
          </div>
        </Fade>
        <Fade delay={.1}>
      ...
      <div className="kymia-founder-grid" style={{maxWidth:900,margin:'0 auto',position:'relative',display:'grid',gridTemplateColumns:'1fr 1.6fr',gap:64,alignItems:'center'}}>
        ...
        <Fade delay={.15}>
          <div>
            ...
            <h2 className="kymia-h2" style={{fontSize:44,fontWeight:900,color:'white',margin:'0 0 8px',lineHeight:1.2,fontFamily:'monospace'}}>Cedrick B.</h2>
            ...
            <p style={{fontSize:15,color:K.dim,lineHeight:1.9,marginBottom:24,margin:'0 0 24px'}}>
      ...
      <div style={{maxWidth:780,margin:'0 auto'}}>
        <Fade>
          <div style={{textAlign:'center',marginBottom:56}}>
            ...
            <h2 className="kymia-h2" style={{fontSize:41,fontWeight:900,color:'white',margin:0}}>Everything you need to know.</h2>
          </div>
        </Fade>
  ...
  return(
    <section className="kymia-section" style={{padding:"80px 40px",background:"rgba(6,10,18,0.4)",borderTop:"1px solid rgba(0,242,254,0.06)"}}>
      <div style={{maxWidth:920,margin:"0 auto",textAlign:"center"}}>
        ...
        <h2 className="kymia-h2" style={{fontSize:39,fontWeight:900,color:"white",margin:"0 0 12px",fontFamily:F,lineHeight:1.2}}>Free to start. Fair to scale.</h2>
        <p style={{fontSize:15,color:K.dim,lineHeight:1.85,marginBottom:40}}>Sandbox is always free. Pay only when you go live.</p>
  ...
  return (
    <div style={{background:K.bg,minHeight:"100vh",fontFamily:F,color:K.hi,overflowX:"hidden"}}>
      ...
      <section className="kymia-section kymia-hero-grid" style={{minHeight:"100vh",display:"grid",gridTemplateColumns:"1fr 1fr",alignItems:"center",position:"relative",padding:"80px 48px 80px",maxWidth:1280,margin:"0 auto",gap:40}}>
        <motion.div initial={{opacity:0,x:-28}} animate={{opacity:1,x:0}} transition={{duration:.8,delay:.1}} style={{flex:"1 1 440px",minWidth:0}}>
          ...
          <div style={{marginBottom:24,lineHeight:1.2}}>
            <div className="kymia-h1" style={{display:"flex",flexWrap:"wrap",gap:12,fontSize:"clamp(36px, 9vw, 66px)",fontWeight:900}}>
              {words.map((w,i)=>(
          ...
          <div className="kymia-body" style={{fontSize:"clamp(15px, 4.2vw, 18px)",color:K.dim,lineHeight:1.9,marginBottom:28,maxWidth:460}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:14}}>
            <div className="kymia-cta-row" style={{display:"flex",gap:10,flexWrap:"wrap"}}>
              ...
              <div>
                <a className="kymia-cta" href="/nexus?mode=live" style={{display:"block",padding:"13px 24px",background:"rgba(0,242,254,0.12)",border:"1.5px solid rgba(0,242,254,0.5)",color:K.c,borderRadius:6,fontSize:14,textDecoration:"none",letterSpacing:".03em",fontFamily:F,fontWeight:700,transition:"all .25s"}}
      ...
      <section className="kymia-section" style={{padding:"100px 48px",textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <Fade>
          <div className="kymia-h1" style={{fontSize:"clamp(36px, 9vw, 66px)",fontWeight:900,color:"#FFFFFF",marginBottom:6,position:"relative",lineHeight:1.2}}>The future of trading</div>
          <div className="kymia-h1" style={{fontSize:"clamp(36px, 9vw, 66px)",fontWeight:900,color:K.c,marginBottom:52,textShadow:`0 0 40px ${K.c}60`,position:"relative",lineHeight:1.2}}>is autonomous.</div>
        </Fade>
        <Fade delay={.12}>
          <p style={{fontSize:15,color:K.dim,lineHeight:1.85,marginBottom:28,position:"relative"}}>
      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        @media (max-width: 768px) {
          ...
          .kymia-h1 { font-size: clamp(33px, 10vw, 50px) !important; line-height: 1.25 !important; }
          .kymia-h2 { font-size: clamp(25px, 7vw, 37px) !important; }
          .kymia-body { font-size: 14px !important; }
        ...
        @media (max-width: 480px) {
          .kymia-h1 { font-size: 33px !important; }
